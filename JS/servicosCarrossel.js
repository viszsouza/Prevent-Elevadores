// Variável para Media query
var larguraTela = window.innerWidth;


// Carrossel Serviços
function direcaoServicos(e){
    // Variável para direção dos cards do carrossel
    var direcao = document.getElementById("contentSlideResidenciais");
    ...
    if(larguraTela >= 390 && larguraTela <= 458){
        // Mover pra direita
        if (e == 1){
            direcao.scrollLeft = direcao.scrollLeft - 280;
        }
...
function direcaoServicosEmpreendimentos(e){
    // Variável para direção dos cards do carrossel
    var direcao = document.getElementById("contentSlideEmpreendimentos");
